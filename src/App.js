...
const App = () => {
  ...
  async function submitDetails() {
    ...
    await axios
      .post("https://newalma-backend.onrender.com/api/booking", bookingData)
      .then((res) => {
  ...
  async function lastBookingDetails() {
    ...
    await axios
      .get("https://newalma-backend.onrender.com/api/booking")
      .then((res) => {
        setLastBooking(res.data);
        setLoading(false);
      })
  ...
  async function deletePreviousBookings() {
    setLoading(true);
    await axios
      .delete("https://newalma-backend.onrender.com/api/booking")
      .then((res) => {
        alert(res.data);
      })
      .catch((err) => {
